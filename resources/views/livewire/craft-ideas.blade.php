<div class="mx-auto max-w-2xl px-4 pb-16 pt-5 sm:px-6">
    ...
    {{-- In-context capture: on the ideas page itself, adding one shouldn't need
         the global panel. "Wo anfangen" stays folded away until it's wanted. --}}
    <form
        wire:submit="addIdea"
        x-data="{ exp: false }"
    ...
    >
        ...
        >
            <div class="flex items-center gap-2 px-3 py-2">
                ...
                />
                <button type="submit" class="grid h-7 w-7 flex-none place-items-center rounded-card bg-forest text-white transition hover:brightness-110 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-forest" aria-label="Idee hinzufügen">
            ...
            <div
                ...
                style="display: none;"
            >
                <label for="craft-where" class="mb-1 block text-[11px] font-medium text-ink-faint">Wo anfangen (optional)</label>
                <input
                    id="craft-where"
                    type="text"
