...
class PomodoroSessionService
{
     ...
     */
    public function start(ScheduleEvent $event): void
    {
        $event->update([
     ...
     */
    public function transition(ScheduleEvent $event, array $rhythm): array
    {
     ...
     */
    public function skipBreak(ScheduleEvent $event, array $rhythm): bool
    {
